...
import { ValuesandVariablesQuest } from "./JAvaScriptQuestion";
...
const ValuesandVariables = () => {
  ...
  const filtered = ValuesandVariablesQuest.filter(
    (q) =>
      ...
      <>
        ...
        <section className="mb-12">
          ...
          <p className="text-lg text-center max-w-3xl mx-auto text-gray-600 dark:text-gray-600">
            Learn how to store and manipulate data using variables and values in
            JavaScript.
          </p>
        </section>
        ...
        >
          ...
          {(languageMode === "english" || languageMode === "both") && (
            <p className="mb-3">
              A <strong>value</strong> is a piece of data that JavaScript can
              work with. It can be a number, string, boolean, object, or
              function.
            </p>
          )}
          ...
          {(languageMode === "urdu" || languageMode === "both") && (
            ...
            >
              <strong>Roman Urdu:</strong> Value woh data hoti hai jis pe
              JavaScript kaam kar sakta hai. Yeh number, string, boolean, object
              ya function ho sakti hai.
            </p>
          )}
        ...
        >
          ...
          {(languageMode === "english" || languageMode === "both") && (
            <p className="mb-3">
              A <strong>variable</strong> is like a container used to store
              values so you can reuse or change them later in your code.
            </p>
          )}
          ...
          {(languageMode === "urdu" || languageMode === "both") && (
            ...
            >
              <strong>Roman Urdu:</strong> Variable ek aisi container ki tarha
              hota hai jisme aap values ko store karte hain taake baad main unhe
              reuse ya change kiya ja sake.
            </p>
          )}
          ...
          <p className="italic text-sm mt-2">
            💡 Tip: Use{" "}
            <code className="bg-yellow-200 px-1 rounded dark:bg-yellow-800">
              const
            </code>{" "}
        ...
        >
          ...
          {(languageMode === "english" || languageMode === "both") && (
            <p className="mb-4">
              Understanding these keywords helps you write safer and more
              predictable code.
            </p>
          )}
          ...
          {(languageMode === "urdu" || languageMode === "both") && (
            ...
            >
              <strong>Roman Urdu:</strong> In keywords ko samajhna aapki coding
              ko zyada safe aur predict karne layaq banata hai.
            </p>
          )}
          ...
          <div className="overflow-x-auto">
            <table className="w-full border-collapse mb-4">
              ...
              <tbody>
                ...
                >
                  <td className="py-2 px-4 font-medium text-purple-500">
                    const
                  </td>
                  <td className="py-2 px-4">Block</td>
                  <td className="py-2 px-4">❌</td>
          ...
          {(languageMode === "english" || languageMode === "both") && (
            <p className={`italic text-sm text-gray-600 dark:text-gray-400`}>
              ...
              due to hoisting and scope issues.
            </p>
          )}
          {(languageMode === "urdu" || languageMode === "both") && (
            <p
              className={`italic text-sm text-gray-600 dark:text-gray-400 mt-1`}
            >
              <strong>Roman Urdu:</strong> Hoisting aur scope ke masail ki waja
              se var istemal na karein.
            </p>
          )}
        </section>
